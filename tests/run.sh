...
assert_status "phase 5 planner has bounded pixel steps" grep -Fq 'requestedDistance = stepCount * stride' "$root_dir/PetRoute.js"
...
assert_status "phase 6 manifest version" jq -e '.version == "2.2.0"' "$root_dir/manifest.json"
...
assert_status "phase 6 host constraints are recorded" grep -Fq 'implicit-grab' "$root_dir/docs/host-verification.md"
assert_status "phase 6 plan has acceptance criteria" grep -Fq 'Every bundled pack renders the intended pose' "$root_dir/docs/plan/phase-6-pet-world.md"
